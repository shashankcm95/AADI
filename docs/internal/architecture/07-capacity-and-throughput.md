...
# Capacity and Throughput Management in Arrive

This section documents how Arrive controls restaurant load, why this mechanism exists, and how it guarantees a predictable customer experience without requiring restaurant acknowledgements.
...
This happens via a single conditional update in the database.
...
Arrive controls load, not people. Capacity is enforced before work is created. Customers get honest timing, restaurants stay sane.
