...
Orders are not pushed to restaurants immediately.
Instead, they are:
...
Orders consume prep units

Prep units are atomically reserved per window
...
The system does not assume customer arrival.
...
Order is created as PENDING_NOT_SENT

No capacity is reserved

Restaurant is not notified
